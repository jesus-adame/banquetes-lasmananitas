...
/** TABLA SEMESTRE DOS */
const ctx2 = document.getElementById("semestre2").getContext('2d');

function cargarVentaSem2() {

   let formData2 = new FormData();
   formData2.append('tabla', 'eventos');
   formData2.append('year', sellyear);
   
   peticionAjax('core/ajax/APIeventos.php', 'mostrar', formData2)
   .then(dataJson => {

      const label_array = ["JUL", "AGO", "SEP", "OCT", "NOV", "DIC"];
      let data_ventas = [];

      data_ventas[0] = dataJson.julio;
      data_ventas[1] = dataJson.agosto;
      data_ventas[2] = dataJson.septiembre;
      data_ventas[3] = dataJson.octubre;
      data_ventas[4] = dataJson.noviembre;
      data_ventas[5] = dataJson.diciembre;
